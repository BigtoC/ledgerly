...
const Set<String> _expectedEnKeys = <String>{
  ...
  // (docs/superpowers/plans/2026-05-07-recurring-transactions.md).
  'settingsRecurringTile',
  'recurringRulesTitle',
  'recurringEmptyHeading',
  'recurringEmptyBody',
  'recurringEmptyCta',
  'recurringFabNew',
  'recurringRulesLoadError',
  'recurringRulesLoadRetry',
  'recurringTileNextDue',
  'recurringTilePaused',
  'recurringSwipePause',
  'recurringSwipeResume',
  'recurringSwipeDelete',
  'recurringPausedSnack',
  'recurringResumedSnack',
  'recurringDeletedSnack',
  'recurringFormCreateTitle',
  'recurringFormEditTitle',
  'recurringFormNamePlaceholder',
  'recurringFrequencyDaily',
  'recurringFrequencyWeekly',
  'recurringFrequencyMonthly',
  'recurringFrequencyYearly',
  'recurringDailyHelper',
  'recurringDayOfMonthHint',
  'recurringFieldRequired',
  'recurringSaveCreate',
  'recurringSaveUpdate',
  'recurringSavedCreate',
  'recurringSavedUpdate',
  'recurringDeleteRule',
