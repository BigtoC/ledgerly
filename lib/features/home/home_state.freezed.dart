...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( DateTime selectedDay,  int pendingBadgeCount)?  empty,TResult Function( DateTime selectedDay,  List<Transaction> transactionsForDay,  DailyTotals todayTotalsByCurrency,  Map<String, int> monthNetByCurrency,  DateTime? prevDayWithActivity,  DateTime? nextDayWithActivity,  int pendingBadgeCount,  PendingDelete? pendingDelete)?  data,TResult Function( Object error,  StackTrace stack)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case HomeLoading() when loading != null:
...
return data(_that.selectedDay,_that.transactionsForDay,_that.todayTotalsByCurrency,_that.monthNetByCurrency,_that.prevDayWithActivity,_that.nextDayWithActivity,_that.pendingBadgeCount,_that.pendingDelete);case HomeError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( DateTime selectedDay,  int pendingBadgeCount)  empty,required TResult Function( DateTime selectedDay,  List<Transaction> transactionsForDay,  DailyTotals todayTotalsByCurrency,  Map<String, int> monthNetByCurrency,  DateTime? prevDayWithActivity,  DateTime? nextDayWithActivity,  int pendingBadgeCount,  PendingDelete? pendingDelete)  data,required TResult Function( Object error,  StackTrace stack)  error,}) {final _that = this;
switch (_that) {
case HomeLoading():
return loading();case HomeEmpty():
return empty(_that.selectedDay,_that.pendingBadgeCount);case HomeData():
return data(_that.selectedDay,_that.transactionsForDay,_that.todayTotalsByCurrency,_that.monthNetByCurrency,_that.prevDayWithActivity,_that.nextDayWithActivity,_that.pendingBadgeCount,_that.pendingDelete);case HomeError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( DateTime selectedDay,  int pendingBadgeCount)?  empty,TResult? Function( DateTime selectedDay,  List<Transaction> transactionsForDay,  DailyTotals todayTotalsByCurrency,  Map<String, int> monthNetByCurrency,  DateTime? prevDayWithActivity,  DateTime? nextDayWithActivity,  int pendingBadgeCount,  PendingDelete? pendingDelete)?  data,TResult? Function( Object error,  StackTrace stack)?  error,}) {final _that = this;
switch (_that) {
case HomeLoading() when loading != null:
return loading();case HomeEmpty() when empty != null:
return empty(_that.selectedDay,_that.pendingBadgeCount);case HomeData() when data != null:
...
class HomeData implements HomeState {
  const HomeData({required this.selectedDay, required final  List<Transaction> transactionsForDay, required final  DailyTotals todayTotalsByCurrency, required final  Map<String, int> monthNetByCurrency, required this.prevDayWithActivity, required this.nextDayWithActivity, required this.pendingBadgeCount, this.pendingDelete}): _transactionsForDay = transactionsForDay,_todayTotalsByCurrency = todayTotalsByCurrency,_monthNetByCurrency = monthNetByCurrency;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeData&&(identical(other.selectedDay, selectedDay) || other.selectedDay == selectedDay)&&const DeepCollectionEquality().equals(other._transactionsForDay, _transactionsForDay)&&const DeepCollectionEquality().equals(other._todayTotalsByCurrency, _todayTotalsByCurrency)&&const DeepCollectionEquality().equals(other._monthNetByCurrency, _monthNetByCurrency)&&(identical(other.prevDayWithActivity, prevDayWithActivity) || other.prevDayWithActivity == prevDayWithActivity)&&(identical(other.nextDayWithActivity, nextDayWithActivity) || other.nextDayWithActivity == nextDayWithActivity)&&(identical(other.pendingBadgeCount, pendingBadgeCount) || other.pendingBadgeCount == pendingBadgeCount)&&(identical(other.pendingDelete, pendingDelete) || other.pendingDelete == pendingDelete));
}


@override
int get hashCode => Object.hash(runtimeType,selectedDay,const DeepCollectionEquality().hash(_transactionsForDay),const DeepCollectionEquality().hash(_todayTotalsByCurrency),const DeepCollectionEquality().hash(_monthNetByCurrency),prevDayWithActivity,nextDayWithActivity,pendingBadgeCount,pendingDelete);

@override
String toString() {
  return 'HomeState.data(selectedDay: $selectedDay, transactionsForDay: $transactionsForDay, todayTotalsByCurrency: $todayTotalsByCurrency, monthNetByCurrency: $monthNetByCurrency, prevDayWithActivity: $prevDayWithActivity, nextDayWithActivity: $nextDayWithActivity, pendingBadgeCount: $pendingBadgeCount, pendingDelete: $pendingDelete)';
}
...
@useResult
$Res call({
 DateTime selectedDay, List<Transaction> transactionsForDay, DailyTotals todayTotalsByCurrency, Map<String, int> monthNetByCurrency, DateTime? prevDayWithActivity, DateTime? nextDayWithActivity, int pendingBadgeCount, PendingDelete? pendingDelete
});
...
/// Create a copy of HomeState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? selectedDay = null,Object? transactionsForDay = null,Object? todayTotalsByCurrency = null,Object? monthNetByCurrency = null,Object? prevDayWithActivity = freezed,Object? nextDayWithActivity = freezed,Object? pendingBadgeCount = null,Object? pendingDelete = freezed,}) {
  return _then(HomeData(
selectedDay: null == selectedDay ? _self.selectedDay : selectedDay // ignore: cast_nullable_to_non_nullable
as DateTime,transactionsForDay: null == transactionsForDay ? _self._transactionsForDay : transactionsForDay // ignore: cast_nullable_to_non_nullable
